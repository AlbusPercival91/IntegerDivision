    ...
    static Stream<Arguments> expectedAndActualStringProvider() {
        return Stream.of(
                arguments(testIfDividerHasOneDigitLessThanFirstVariable,
                        Facade.divisionDraw(Division.divisionCalculation(78945, 4))),
                arguments(testIfDividerHasTwoEqualDigitsGreaterThanFirstVariable,
                        Facade.divisionDraw(Division.divisionCalculation(78945, 99))),
                arguments(testIfDividerHasTwoEqualDigitsLessThanFirstVariable,
                        Facade.divisionDraw(Division.divisionCalculation(78945, 66))),
                arguments(testIfDividerHasTwoDigitsLessThanFirstVariable,
                        Facade.divisionDraw(Division.divisionCalculation(78945, 65))),
                arguments(testIfDividerHasTwoEqualDigitsCloseLessThanFirstVariable,
                        Facade.divisionDraw(Division.divisionCalculation(78945, 77))),
                arguments(testIfDividerAndVariableIsEquals,
                        Facade.divisionDraw(Division.divisionCalculation(12345, 1))),
                arguments(testIfDividerAndVariableIsEqualsWithZeroes,
                        Facade.divisionDraw(Division.divisionCalculation(1010101, 1))),
                arguments(testIfDividerAndFewDividendDigitsIsEqualsWithZero,
                        Facade.divisionDraw(Division.divisionCalculation(111010111, 1))),
                arguments(testIfTwoZeroesInDividendAndLastDigitEqualsDivider,
                        Facade.divisionDraw(Division.divisionCalculation(1004, 4))),
                arguments(testIfThreeZeroesInDividendAndLastDigitEqualsDivider,
                        Facade.divisionDraw(Division.divisionCalculation(10004, 4))),
                arguments(testIfZeroesInDividendAndLastDigitEqualsDivider,
                        Facade.divisionDraw(Division.divisionCalculation(1000404, 4))),
                arguments(testIfDividerEqualsAllVariablesSeparateByZero,
                        Facade.divisionDraw(Division.divisionCalculation(120120120, 12))),
                arguments(testIfFirstAndLastDigitEqualDividerSeparateByZero,
                        Facade.divisionDraw(Division.divisionCalculation(1000001, 1))),
                arguments(testIfDividerNotEqualsVariablesSeparateByZero,
                        Facade.divisionDraw(Division.divisionCalculation(1000404, 5))),
                arguments(testIfDividerGreaterThanDividendWithSameDigits,
                        Facade.divisionDraw(Division.divisionCalculation(123, 1234))),
                arguments(testIfDividendIsZero, Facade.divisionDraw(Division.divisionCalculation(0, 1234))),
                arguments(testIfDividerIsNegative, Facade.divisionDraw(Division.divisionCalculation(1000404, -5))),
                arguments(testIfDividendIsNegative, Facade.divisionDraw(Division.divisionCalculation(-78, 910))));
    }
}
